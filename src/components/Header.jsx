    ...
    >
      ...
      className="flex flex-wrap gap-2 mt-10 justify-center">
        {Array(6).fill('').map((item, index) => (
            ...
            className="rounded hover:scale-105 trasition-all duration-300 cursor-pointer max-sm:w-10" src={index % 2== 0 ? assets.sample_img_2 : assets.sample_img_1} alt="" srcset="" key={index} width={70} />
        ))}
      </motion.div>
      <motion.p 
        initial = {{opacity: 0}}
      ...
      className="text-neutral-600 text-center mt-3">Generated images from imagify</motion.p>
